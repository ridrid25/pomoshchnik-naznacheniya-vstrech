...
M11 Mini App завершён: к центру управления добавлены состояние помощника, автоматическая проверка и безопасное восстановление Telegram, уведомлений и отметок Google Calendar, а также готовый отчёт для Codex без паролей и личных данных.
