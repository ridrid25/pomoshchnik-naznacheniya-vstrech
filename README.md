...
M7 Mini App: администратор сверяет занятость в нужном дне Google Calendar, возвращается к той же заявке и принимает решение. В центре управления видны состояние интеграции, подключённый аккаунт и рабочие периоды; там же сохраняются минимальный срок записи, горизонт, дневной лимит и буферы между встречами.
