...
M10 Mini App: развиваем центр управления администратора. В M10.1 добавлено управление закрытыми днями и отдельными интервалами, которые сразу исключаются из свободных окон бота и Mini App.
