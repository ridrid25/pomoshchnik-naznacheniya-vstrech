...
M9 Mini App: надёжное согласование после завершённого пилота M8. Очередь администратора проверяет занятость предложенного времени в реальном времени и не позволяет подтверждать слот, который уже занят в Google Calendar.
