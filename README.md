...
M10 Mini App завершён: центр управления включает состояние Google Calendar, часовые пояса России, основные правила и рабочие часы недели, закрытые даты, заблокированных пользователей и редактор шаблонов уведомлений.
